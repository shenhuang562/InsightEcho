...
import com.InsightEcho.mapper.BlogFileMapper;
...
import com.InsightEcho.utils.FileUtils;
...
import static com.InsightEcho.constant.CommonConstant.FALSE;
import static com.InsightEcho.constant.CommonConstant.TRUE;
...
public class BlogFileService extends ServiceImpl<BlogFileMapper, BlogFile> {
    ...
    public void createFolder(FolderReq folder) {
        ...
        log.info("Attempting to create folder: {} in path: {}", fileName, filePath);
        // 判断目录是否存在
            ...
            if (FileUtils.mkdir(directory)) {
                log.info("Folder created successfully: {}", directory.getAbsolutePath());
                ...
                log.error("Failed to create folder: {}", directory.getAbsolutePath());
